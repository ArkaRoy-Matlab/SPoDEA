% ***************************************************************
% *** Matlab function for synthetic model-1 with varying density is a part of SPoDEA programe that includes a set of *.m files to compute basement depth of the complex sedimentary basin.  
...
%Code for synthetic model(1) having depth varying density for inversion of gravity data
clear all
close all
%%%%%%%%%%%%%%%%%%%%%%%%     Part 1.    %%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%    Plotting the results obtained form Differential Evolution   %%%%
     ...
     zz1=poly_gravityrho(xx,0,x1,y1,@(z) (-0.55-2.5*10^-3.*z).*1000,t_leg,c_leg);
     ...
     zd=(-0.55-2.5*10^-3.*depth).*1000; %density of the profile
     %true model 
     patch(xx,depth,zd)
     colormap winter
     %optimized model 
     ...
     xlabel('Observation points in meter')
     ylabel('Gravity anomaly in mGal')
     title('Residual of Gravity anomaly for Model 1 ')
     ...
     xlabel('Distance in meter')
     ylabel('Depth in meter')
     title('Residual in depth profile of synthetic basin (Model 1)')
     ...
     title('Error Energy plot Model 1')
     legend('With Noise')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%     Part 4.    %%%%%%%%%%%%%%%%%%%%%%%%
