% ***************************************************************
% *** Matlab function for prismatic model-1 with varying density is a part of SPoDEA programe that includes a set of *.m files to compute basement depth of the complex sedimentary basin.  
...
%Code for Comparative study of Prismatic model with SPoDEA for Model-1 with
...
while RMSE_g>=0.19 %(desired stopping criterion same as best RMSE from SPoDEA)
