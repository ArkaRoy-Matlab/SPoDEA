% ***************************************************************
% *** Matlab function for prismatic model-1 with fixed density is a part of SPoDEA programe that includes a set of *.m files to compute basement depth of the complex sedimentary basin.  
...
while RMSE_g>=0.18 %(desired stopping criterion same as best RMSE from SPoDEA)
