% ***************************************************************
% *** Matlab function for synthetic model-1 with fixed density is a part of SPoDEA programe that includes a set of *.m files to compute basement depth of the complex sedimentary basin.  
...
%Code for synthetic model(1) having fixed density for inversion of gravity data
clear all
close all
%%%%%%%%%%%%%%%%%%%%%%%%     Part 1.    %%%%%%%%%%%%%%%%%%%%%%%%
